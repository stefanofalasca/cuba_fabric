...
public class JscomponentTestContainer extends TestContainer {

    public JscomponentTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "it/osl/jscomponent/app.properties",
    ...
    public static class Common extends JscomponentTestContainer {

        public static final JscomponentTestContainer.Common INSTANCE = new JscomponentTestContainer.Common();
